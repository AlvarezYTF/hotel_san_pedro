        ...
        <div class="p-5 border-b border-gray-50 bg-gray-50/50 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button type="submit" form="reservation-form"
                        @if(!$this->isValid || $this->loading) disabled @endif
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
                <div class="p-5 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                    ...
                    <button type="button" wire:click="$set('newCustomerModalOpen', true)" class="text-xs font-bold text-blue-600 hover:text-blue-800 flex items-center">
                        ...
                        <div class="relative" id="customer-selector-container">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                       ...
                                       wire:keydown.escape="$set('showCustomerDropdown', false)"
                                ...
                                @if($this->customerId)
                                    <button type="button"
                                            wire:click="$set('customerId', ''); $set('customerSearchTerm', ''); $set('showCustomerDropdown', false)"
                            ...
                            <input type="hidden" name="customer_id" wire:model="customerId" required>

                            <!-- Dropdown Results -->
                            @if($showCustomerDropdown && $this->datesCompleted)
                                <div class="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-xl shadow-lg max-h-64 overflow-y-auto"
                                     wire:ignore.self>
                                    @php
                            ...
                            @if($this->customerId && !$showCustomerDropdown)
                                ...
                                @if($selectedCustomer)
                                    <div class="mt-2 p-3 bg-emerald-50 rounded-xl border border-emerald-200 flex items-center justify-between">
                                        ...
                                        <button type="button"
                                                wire:click="$set('customerId', ''); $set('customerSearchTerm', '')"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="check_in_date" wire:model.live="checkIn" required
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="check_out_date" wire:model.live="checkOut" required
                                       class="block w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-emerald-500 focus:border-emerald-500 @error('checkOut') border-red-500 @enderror">
                            </div>
                            @error('checkOut')
                                <span class="mt-1 text-[10px] font-bold text-red-500 uppercase tracking-tighter block">
                                    <i class="fas fa-exclamation-triangle mr-1"></i> {{ $message }}
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="time" name="check_in_time" wire:model.live="checkInTime"
                                       class="block w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-emerald-500 focus:border-emerald-500 @error('checkInTime') border-red-500 @enderror">
                                @error('checkInTime')
                                    <span class="mt-1 text-[10px] font-bold text-red-500 uppercase tracking-tighter block">
                                        <i class="fas fa-exclamation-triangle mr-1"></i> {{ $message }}
                                    </span>
                        ...
                        <div>
                            ...
                            @if(!$this->showMultiRoomSelector)
                                <div>
                                    ...
                                    <select name="room_id" id="room_id" wire:model.live="roomId"
                                            @if(!$this->datesCompleted) disabled @endif
                                            class="w-full @if(!$this->datesCompleted) bg-gray-100 cursor-not-allowed @endif">
                            ...
                            @if($this->showMultiRoomSelector)
                                <div class="space-y-3">
                                    ...
                                    <div class="border border-gray-300 rounded-xl p-4 max-h-64 overflow-y-auto bg-white"
                            ...
                            <div class="bg-gray-50 rounded-2xl p-4 border border-gray-100 flex flex-col justify-center space-y-3">
                                ...
                                @if($this->guestsCount > 0)
                                    <div class="text-[10px] text-gray-500 italic text-center">
                                        <span>Para {{ $this->guestsCount }} {{ $this->guestsCount == 1 ? 'persona' : 'personas' }}</span>
                                    </div>
                                @endif
                        ...
                        @if(!$this->showMultiRoomSelector)
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="guests_count" wire:model.live="guestsCount" min="1"
                                           max="{{ $this->selectedRoom ? ($this->selectedRoom['capacity'] ?? 10) : 10 }}" required
                                           @if(!$this->datesCompleted) disabled @endif
                                           class="block w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-emerald-500 focus:border-emerald-500 disabled:bg-gray-100 disabled:cursor-not-allowed">
                                </div>
                                @if($this->selectedRoom && $this->guestsCount > ($this->selectedRoom['capacity'] ?? 0))
                        ...
                        @if($this->showMultiRoomSelector)
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="guests_count" value="{{ $this->calculateTotalGuestsCount() }}" readonly
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <textarea name="notes" wire:model="notes" rows="3" class="w-full border-gray-300 rounded-xl text-sm focus:ring-emerald-500 focus:border-emerald-500"
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="total_amount" wire:model.live="total" step="1" required
                        ...
                        @if($this->autoCalculatedTotal > 0 && $total != $this->autoCalculatedTotal)
                            <button type="button" wire:click="$set('total', $this->autoCalculatedTotal)" class="text-[10px] font-bold text-emerald-400 hover:text-emerald-300 underline uppercase tracking-tighter">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 font-bold">$</span>
                            <input type="number" name="deposit" wire:model.live="deposit" step="1" required
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ open: @entangle('newCustomerModalOpen') }" x-show="open"
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="fixed inset-0 bg-gray-900/60 backdrop-blur-sm transition-opacity"
                     @click="$wire.set('newCustomerModalOpen', false)"></div>
                ...
                <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full"
                    ...
                    <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50">
                        ...
                        <button type="button" wire:click="$set('newCustomerModalOpen', false)"
