...
function reservationForm() {
    return {
        ...
        showMultiRoomSelector: false,
        selectedRoomIds: [],
        roomGuests: {}, // Maps roomId => array of guest objects
        currentRoomForGuestAssignment: null, // Track which room we're assigning guests to
        ...
        assignedGuests: [], // For single room mode (backward compatibility)
