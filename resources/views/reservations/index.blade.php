...
@section('content')
    ...
    <x-reservations.create-modal :modalRooms="$modalRooms ?? []" :modalRoomsData="$modalRoomsData ?? []" :modalCustomers="$modalCustomers ?? []" :modalIdentificationDocuments="$modalIdentificationDocuments ?? []" :modalLegalOrganizations="$modalLegalOrganizations ?? []"
        :modalTributes="$modalTributes ?? []" :modalMunicipalities="$modalMunicipalities ?? []" />
